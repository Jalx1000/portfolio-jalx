...
const Footer = () => {
  return (
    <footer className="w-100%">
      <section className="pl-3 md:pl-0 w-[90%] md:w-[90%] m-auto flex flex-col-reverse sm:flex-col md:flex-row md:space-between justify-center border-t-2 border-white pt-[75px] pb-[30px]">
        <div className="">
